...
public class Signup extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		String ac = (String)c1.getSelectedItem();//getSelectedItem() will return an object so we need to cast it;
		...
		try 
		{
			...
			else
			{
				...
				String q1 = "insert into signup values(null, '"+a+"','"+b+"', '"+ac+"', '"+bc+"', '"+cc+"', '"+d+"', '"+ee+"', '"+f+"', '"+g+"', '"+h+"', '"+i+"', '"+j+"')";
